...
"[project]/Sistema/app/api/products/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const rateLimitCheck = __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$security$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiLimiter"].check(`products:get:${ip}`);
        ...
        let products;
        if (search && category) {
            products = await __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        SELECT 
...
async function POST(request) {
    try {
        const ip = request.headers.get('x-forwarded-for') || 'unknown';
        const rateLimitCheck = __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$security$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiLimiter"].check(`products:post:${ip}`);
        if (!rateLimitCheck.allowed) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'Rate limit exceeded'
        ...
        const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$security$2f$input$2d$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateProduct"])(body);
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
    ...
    `;
        ...
        // Insertar producto
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
...
async function DELETE(request) {
    try {
        const ip = request.headers.get('x-forwarded-for') || 'unknown';
        const rateLimitCheck = __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$security$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiLimiter"].check(`products:delete:${ip}`);
        if (!rateLimitCheck.allowed) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'Rate limit exceeded'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb1da905._.js.map