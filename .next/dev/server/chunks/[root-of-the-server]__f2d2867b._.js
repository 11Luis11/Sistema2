...
"[project]/Sistema/app/api/products/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const rateLimitCheck = __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$security$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiLimiter"].check(`products:put:${ip}`);
        ...
        const currentProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
    ...
    `;
        ...
        let result;
        if (newStock !== null) {
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$Sistema$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sql"]`
        UPDATE products 
        SET name = ${name},
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2d2867b._.js.map